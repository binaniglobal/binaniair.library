...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Home /</span> Permissions</h4>
            ...
            <div class="card-datatable table-responsive text-nowrap">
                <table class="dt-responsive table table-hover" id="dt-responsive">
                    ...
                    @foreach($Permission as $permissions)
                        <tr>
                            <td>{{ ucfirst($permissions->name) }}</td>
                            <td>
                                <div class="dropdown">
        ...
        <script>
            $("#dt-responsive").DataTable({
                ...
                buttons: [
                    'pageLength',
                    {
                        html: '<a class="btn btn-primary" href="{{ route('permissions.create') }}"><span class="fa fa-plus-circle" aria-hidden="true"></span> ' +
