                        ...
                        @foreach($Items as $items)
                            ...
                            @can('access-manual-'.$parentManual->name.'.'.$items->name)
                                <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                @if($items->file_type === 'application/pdf')
                                                    ...
                                                    <span class="cache-status text-success ms-2" data-raw-url="{{ route('manual.items.raw', ['filename' => $items->link]) }}"></span>
                                                @else
                                    ...
                                    <td>
                                        <div class="dropdown" data-cache-container data-raw-url="{{ route('manual.items.raw', ['filename' => $items->link]) }}">
