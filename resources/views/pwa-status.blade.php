...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // PWA Installation Logic (omitted for brevity, assuming it exists)
        ...
        // Load cache stats on load and when refresh is clicked
        loadCacheStats();
    ...
    async function clearCache() {
        if (confirm('Are you sure you want to clear all cached PDF files?')) {
            ...
            try {
                await caches.delete('library-manuals-v1.0.1');
