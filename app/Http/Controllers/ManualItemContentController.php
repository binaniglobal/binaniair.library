...
class ManualItemContentController extends Controller
{
    ...
    {
        return view('manuals.items.contents.index', ['Id' => $id, 'Manual' => ManualsItem::where('miid', $id)->first(), 'Items' => ManualItemContent::where('manual_items_uid', $id)->oldest('created_at')->get()]);
    }
